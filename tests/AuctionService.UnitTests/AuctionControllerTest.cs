...
public class AuctionControllerTest
{
    ...
    public AuctionControllerTest()
    {
        ...
        _controller = new AuctionsController(_auctionRepo.Object, _mapper,
    ...
    [Fact]
    public async Task CreateAuction_WithValidCreateAuctionDto_ReaturnsCreatedAtAction()
    {
        // arrange
    ...
    public async Task UpdateAuction_WithUpdateAuctionDto_ReturnsOkResponse()
    {
        ...
        //act
        var result = await _controller.UpdateAuction(auction.Id, updatedAuctionDto);
    ...
    public async Task UpdateAuction_WithInvalidGuid_ReturnsNotFound()
    {
        ...
        //act
        var result = await _controller.UpdateAuction(Guid.NewGuid(), updatedAuctionDto);
